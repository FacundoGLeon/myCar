...
<style>
    /* Ajustes para que el calendario se vea enorme y ocupe el ancho disponible */
    ...
    /* Diseño para los días OCUPADOS (Tachados y con fondo tenue) */
    ...
    /* Diseño para los días disponibles */
    .flatpickr-day:not(.flatpickr-disabled) {
        font-weight: 500;
        color: var(--primary-color); 
    }

    /* Evitamos que el día actual ("hoy") se pinte raro si está disponible */
    .flatpickr-day.today {
    ...
    /* SOBRESCRIBIR EL AZUL POR DEFECTO DE FLATPICKR */
    ...
    /* Días intermedios de la selección (gris azulado claro) */
        ...
        <div class="card border-0 shadow-lg overflow-hidden rounded-4">
            <div class="row g-0">
                ...
                <div class="col-md-5 bg-light border-end">
                    ...
                    <div class="p-4">
                        <h3 class="fw-bold mb-1" style="color: var(--primary-color);"><?= $v['marca'] ?> <?= $v['modelo'] ?></h3>
                        <p class="text-muted mb-3"><i class="bi bi-tag-fill me-2"></i>Año <?= $v['anio'] ?> • <?= $v['plazas'] ?> Plazas</p>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <span class="badge border bg-white text-dark fw-normal shadow-sm px-2 py-2">
                                    <i class="bi bi-signpost-split text-primary me-1"></i> Km: <?= number_format($v['kilometraje'], 0, ',', '.') ?>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-3 rounded-3 shadow-sm border mb-3 text-center">
                            ...
                            <h3 class="fw-bold text-success mb-0" id="precio_base" data-precio="<?= $v['precio_dia'] ?>">
                                $<?= number_format($v['precio_dia'], 2, ',', '.') ?> <span class="fs-6 text-muted fw-normal">/día</span>
                            </h3>
                        </div>
                        
                        <div class="alert alert-secondary border-0 shadow-sm mt-4 text-center">
                            <i class="bi bi-info-circle me-1"></i> Las fechas <span class="text-decoration-line-through text-muted fw-bold">tachadas</span> ya se encuentran reservadas.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-7 p-4 p-lg-5">
                    ...
                    <form action="<?= base_url('reserva/guardar/' . $v['id']) ?>" method="POST" id="formReserva">
                        ...
                        <div class="row align-items-center bg-light p-3 rounded-3 border border-2 mb-4" style="border-color: var(--primary-color) !important;">
                            <div class="col-6">
                            ...
                            <div class="col-6 text-end border-start">
                                ...
                                <h2 class="mb-0 fw-bold" style="color: var(--primary-color);" id="total_dinamico">$0,00</h2>
                            </div>
                        </div>

                        <button type="submit" class="btn btn-mycar btn-lg w-100 fw-bold shadow-sm" id="btnConfirmar" disabled>
                            <i class="bi bi-calendar-range me-2"></i> Selecciona las fechas arriba
                        </button>
                        <a href="<?= base_url('catalogo') ?>" class="btn btn-link w-100 text-muted mt-2">Cancelar y Volver al Catálogo</a>
                    </form>
                </div>
            </div>
        </div>
